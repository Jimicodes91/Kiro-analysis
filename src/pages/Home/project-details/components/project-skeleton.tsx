...
const ProjectDetailSkeleton: React.FC = () => {
  return (
    <div className="p-6 h-full space-y-6 flex flex-col min-h-[calc(100vh-70px)] animate-pulse">
      <div>
        <div className="mb-1">
      ...
      <div className="bg-white grid grid-cols-auth-layout flex-1 gap-x-3 rounded-lg border border-brand-border p-3">
